...
//  tinyhsp
//
//  Created by 半澤聡 on 2017/05/25.
//  Copyright © 2017年 dolphilia. All rights reserved.
//
...
int old_window_border; // 0=標準、1=枠無し 比較用
@property (nonatomic, readwrite)
BOOL is_startax_in_resource; //リソース内にstart.axがあるか
...
@property (nonatomic, readwrite)
NSString* current_directory_path; //実行中のカレントディレクトリ
@property (nonatomic, readwrite)
NSString* current_script_path; //スクリプトファイルのあるディレクトリのパス
@property (nonatomic, readwrite)
NSURL* current_script_url; //スクリプトファイルのあるディレクトリのURL
